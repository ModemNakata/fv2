import { Component, DOMEvent, EventsController, EventsTarget, State, ViewController, animationFrameThrottle, appendTriggerEvent, ariaBool as ariaBool$1, camelToKebabCase, computed, createContext, createDisposalBin, createScope, deferredPromise, effect, findTriggerEvent, functionDebounce, functionThrottle, hasProvidedContext, hasTriggerEvent, isArray, isKeyboardClick, isKeyboardEvent, isMouseEvent, isNull, isNumber, isObject, isPointerEvent, isString, isTouchEvent, isUndefined, isWriteSignal, kebabToCamelCase, listenEvent, method, noop, onDispose, peek, prop, provideContext, r, scoped, setAttribute, setStyle, signal, tick, untrack, uppercaseFirstChar, useContext, useState, walkTriggerEventChain, wasEnterKeyPressed } from "./chunks/vidstack-CgxsH2Dv.js";
import { AUDIO_EXTENSIONS, AUDIO_TYPES, DASH_VIDEO_EXTENSIONS, DASH_VIDEO_TYPES, HLS_VIDEO_EXTENSIONS, HLS_VIDEO_TYPES, TextTrack, TextTrackSymbol, TimeRange, VIDEO_EXTENSIONS, VIDEO_TYPES, boundTime, canChangeVolume, canGoogleCastSrc, canOrientScreen, canPlayHLSNatively, canRotateScreen, canUsePictureInPicture, canUseVideoPresentation, findActiveCue, getDownloadFile, getRequestCredentials, getTimeRangesEnd, getTimeRangesStart, isAudioSrc, isCueActive, isDASHSrc, isDASHSupported, isHLSSrc, isHLSSupported, isMediaStream, isTrackCaptionKind, isVideoSrc, mediaState, normalizeTimeIntervals, parseJSONCaptionsFile, preconnect, softResetMediaState, updateTimeIntervals, watchActiveTextTrack, watchCueTextChange } from "./chunks/vidstack-CdA8_pp_.js";
import { autoPlacement, clampNumber, getNumberOfDecimalPlaces, hasAnimation, isAudioProvider, isDASHProvider, isElementParent, isEventInside, isGoogleCastProvider, isHLSProvider, isHTMLAudioElement, isHTMLElement, isHTMLIFrameElement, isHTMLMediaElement, isHTMLVideoElement, isTouchPinchEvent, isVideoProvider, isVimeoProvider, isYouTubeProvider, observeVisibility, onPress, requestScopedAnimationFrame, round, setARIALabel, setAttributeIfEmpty } from "./chunks/vidstack-C0MM2kpJ.js";
import fscreen from "fscreen";
//#region src/foundation/logger/grouped-log.ts
...
//#endregion
//#region src/foundation/logger/controller.ts
var Logger = class {
	#target = null;
	error(...data) {
...
//#endregion
//#region src/foundation/list/list.ts
...
//#endregion
//#region src/foundation/fullscreen/controller.ts
...
//#endregion
//#region src/foundation/orientation/controller.ts
...
//#endregion
//#region src/core/state/media-storage.ts
...
//#endregion
//#region src/foundation/list/select-list.ts
...
//#endregion
//#region src/core/tracks/audio/audio-tracks.ts
/**
...
//#endregion
//#region src/core/tracks/text/render/native-text-renderer.ts
...
//#endregion
//#region src/core/tracks/text/render/text-renderer.ts
...
//#endregion
//#region src/core/tracks/text/text-tracks.ts
/**
...
//#endregion
//#region src/core/quality/video-quality.ts
/**
...
//#endregion
//#region src/core/quality/utils.ts
...
//#endregion
//#region src/core/api/player-controller.ts
var MediaPlayerController = class extends ViewController {};
//#endregion
//#region src/core/keyboard/controller.ts
...
//#endregion
//#region src/core/keyboard/aria-shortcuts.ts
...
//#endregion
//#region src/providers/audio/loader.ts
...
//#endregion
//#region src/providers/video/loader.ts
...
//#endregion
//#region src/providers/hls/loader.ts
...
//#endregion
//#region src/providers/dash/loader.ts
...
//#endregion
//#region src/providers/vimeo/loader.ts
var VimeoProviderLoader = class {
	...
	async loadPoster(src, ctx, abort) {
		const { resolveVimeoVideoId, getVimeoVideoInfo } = await import("./chunks/vidstack-CTc8ERfa.js");
...
//#endregion
//#region src/providers/youtube/loader.ts
var YouTubeProviderLoader = class {
	...
	async loadPoster(src, ctx, abort) {
		const { findYouTubePoster, resolveYouTubeVideoId } = await import("./chunks/vidstack-DrAnn52e.js");
...
//#endregion
//#region src/core/api/media-attrs.ts
...
//#endregion
//#region src/core/api/player-props.ts
...
//#endregion
//#region src/core/state/media-load-controller.ts
...
//#endregion
//#region src/core/state/media-player-delegate.ts
...
//#endregion
//#region src/foundation/queue/queue.ts
var Queue = class {
...
//#endregion
//#region src/foundation/queue/request-queue.ts
...
//#endregion
//#region src/core/state/media-request-manager.ts
/**
	...
	async requestGoogleCast(trigger) {
		try {
			...
			if (!this.#googleCastLoader) {
				const $module = await import("./chunks/vidstack-CFjXz-ia.js");
...
//#endregion
//#region src/core/state/media-state-manager.ts
/**
...
var MediaStateManager = class extends MediaPlayerController {
	...
	["media-type-change"](event) {
		...
		if (viewType !== currentViewType) this.$state.inferredViewType.set(currentViewType);
	}
...
//#endregion
//#region src/core/state/media-state-sync.ts
/**
...
//#endregion
//#region src/core/state/navigator-media-session.ts
const actions = [
	"play",
	"pause",
	"seekforward",
...
//#endregion
//#region src/foundation/observers/focus-visible.ts
...
//#endregion
//#region src/components/player.ts
/**
...
var MediaPlayer = class MediaPlayer extends Component {
	...
	#watchTitle() {
		this.$el;
		const { ariaLabel } = this.$props, { title, live, viewType, providedTitle } = this.$state, isLive = live(), type = uppercaseFirstChar(viewType()), typeText = type !== "Unknown" ? `${isLive ? "Live " : ""}${type}` : isLive ? "Live" : "Media", currentTitle = title(), label = ariaLabel() || `${typeText} Player` + (currentTitle ? ` - ${currentTitle}` : "");
...
//#endregion
//#region src/components/provider/source-select.ts
...
//#endregion
//#region src/components/provider/tracks.ts
var Tracks = class {
	#domTracks;
	#media;
	#prevTracks = [];
...
//#endregion
//#region src/components/aria/announcer.ts
/**
...
//#endregion
//#region src/components/ui/controls.ts
/**
...
//#endregion
//#region src/components/ui/controls-group.ts
/**
...
//#endregion
//#region src/components/ui/popper/popper.ts
...
//#endregion
//#region src/components/ui/tooltip/tooltip-context.ts
const tooltipContext = createContext();
//#endregion
//#region src/components/ui/tooltip/tooltip.ts
let id = 0;
/**
...
//#endregion
//#region src/components/ui/tooltip/tooltip-trigger.ts
/**
...
//#endregion
//#region src/components/ui/tooltip/tooltip-content.ts
/**
...
//#endregion
//#region src/components/ui/buttons/toggle-button-controller.ts
...
//#endregion
//#region src/components/ui/buttons/toggle-button.ts
/**
...
//#endregion
//#region src/components/ui/buttons/airplay-button.ts
/**
...
//#endregion
//#region src/components/ui/buttons/google-cast-button.ts
/**
...
//#endregion
//#region src/components/ui/buttons/play-button.ts
/**
...
//#endregion
//#region src/components/ui/buttons/caption-button.ts
/**
...
//#endregion
//#region src/components/ui/buttons/fullscreen-button.ts
/**
...
//#endregion
//#region src/components/ui/buttons/mute-button.ts
/**
...
//#endregion
//#region src/components/ui/buttons/pip-button.ts
/**
...
//#endregion
//#region src/components/ui/buttons/seek-button.ts
/**
...
//#endregion
//#region src/components/ui/buttons/live-button.ts
/**
...
//#endregion
//#region src/components/ui/sliders/slider/api/state.ts
...
//#endregion
//#region src/foundation/observers/intersection-observer.ts
...
//#endregion
//#region src/components/ui/sliders/slider/slider-context.ts
const sliderContext = createContext();
const sliderObserverContext = createContext();
//#endregion
//#region src/components/ui/sliders/slider/utils.ts
...
//#endregion
//#region src/components/ui/sliders/slider/events-controller.ts
/**
...
//#endregion
//#region src/components/ui/sliders/slider/format.ts
const sliderValueFormatContext = createContext(() => ({}));
//#endregion
//#region src/components/ui/sliders/slider/slider-controller.ts
...
//#endregion
//#region src/components/ui/sliders/slider/slider.ts
/**
...
//#endregion
//#region src/components/ui/thumbnails/thumbnail-loader.ts
...
//#endregion
//#region src/components/ui/thumbnails/thumbnail.ts
/**
...
//#endregion
//#region src/components/ui/sliders/slider-video.ts
/**
...
//#endregion
//#region src/components/ui/sliders/slider-value.ts
/**
...
//#endregion
//#region src/components/ui/sliders/slider-preview.ts
/**
...
//#endregion
//#region src/components/ui/sliders/volume-slider.ts
/**
...
//#endregion
//#region src/components/ui/sliders/audio-gain-slider.ts
/**
...
//#endregion
//#region src/components/ui/sliders/speed-slider.ts
/**
...
//#endregion
//#region src/components/ui/sliders/quality-slider.ts
/**
...
//#endregion
//#region src/components/ui/sliders/time-slider/time-slider.ts
/**
...
//#endregion
//#region src/components/ui/sliders/time-slider/slider-chapters.ts
/**
...
//#endregion
//#region src/components/ui/menu/menu-context.ts
...
//#endregion
//#region src/components/ui/menu/menu-focus-controller.ts
...
//#endregion
//#region src/components/ui/menu/menu.ts
let idCount = 0;
/**
...
//#endregion
//#region src/components/ui/menu/menu-button.ts
/**
...
//#endregion
//#region src/components/ui/menu/menu-item.ts
/**
...
//#endregion
//#region src/components/ui/menu/menu-portal.ts
/**
...
//#endregion
//#region src/components/ui/menu/menu-items.ts
/**
...
//#endregion
//#region src/components/ui/menu/radio/radio-controller.ts
const radioControllerContext = createContext();
//#endregion
//#region src/components/ui/menu/radio/radio-group-controller.ts
...
//#endregion
//#region src/components/ui/menu/radio/radio-group.ts
/**
...
//#endregion
//#region src/components/ui/menu/radio/radio.ts
/**
...
//#endregion
//#region src/components/ui/menu/radio-groups/chapters-radio-group.ts
/**
...
var ChaptersRadioGroup = class extends Component {
	...
	onSetup() {
		...
		this.setAttributes({ "data-thumbnails": () => !!thumbnails() });
	}
	onAttach(el) {
		this.#menu?.attachObserver({ onOpen: this.#onOpen.bind(this) });
	}
	getOptions() {
	...
	#onCuesChange(track) {
		const { seekableStart, seekableEnd } = this.#media.$state, startTime = seekableStart(), endTime = seekableEnd();
		this.#cues.set([...track.cues].filter((cue) => cue.startTime <= endTime && cue.endTime >= startTime));
	}
	#watchCurrentTime() {
		...
		if (activeCueIndex >= 0) requestScopedAnimationFrame(() => {
			if (!this.connectScope) return;
...
__decorate([prop], ChaptersRadioGroup.prototype, "value", null);
__decorate([prop], ChaptersRadioGroup.prototype, "disabled", null);
__decorate([method], ChaptersRadioGroup.prototype, "getOptions", null);
//#endregion
//#region src/components/ui/menu/radio-groups/audio-radio-group.ts
/**
...
var AudioRadioGroup = class extends Component {
	static props = { emptyLabel: "Default" };
	#menu;
	#media;
	#controller;
	get value() {
...
//#endregion
//#region src/components/ui/menu/radio-groups/audio-gain-radio-group.ts
...
//#endregion
//#region src/components/ui/menu/radio-groups/captions-radio-group.ts
/**
...
var CaptionsRadioGroup = class extends Component {
	...
	#watchHintText() {
		...
		this.#menu?.hint.set(track && isTrackCaptionKind(track) && track.mode === "showing" ? track.label : offLabel());
	}
	#watchControllerDisabled() {
		this.#menu?.disable(this.disabled);
	}
...
//#endregion
//#region src/components/ui/menu/radio-groups/speed-radio-group.ts
...
//#endregion
//#region src/components/ui/menu/radio-groups/quality-radio-group.ts
/**
...
var QualityRadioGroup = class extends Component {
	...
	#watchHintText() {
		...
		this.#menu?.hint.set(!autoQuality() ? qualityText : autoLabel() + (qualityText ? ` (${qualityText})` : ""));
	}
	#watchControllerDisabled() {
		this.#menu?.disable(this.disabled);
	}
...
//#endregion
//#region src/components/ui/gesture.ts
/**
...
//#endregion
//#region src/components/ui/captions/captions-renderer.ts
...
//#endregion
//#region src/components/ui/captions/captions.ts
/**
...
//#endregion
//#region src/components/ui/poster.ts
/**
...
//#endregion
//#region src/components/ui/time.ts
/**
...
//#endregion
//#region src/components/layouts/plyr/plyr-layout.ts
