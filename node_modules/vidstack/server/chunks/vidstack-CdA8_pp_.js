import { DOMEvent, EventsTarget, State, deferredPromise, getScope, isArray, isBoolean, isFunction, isNull, isNumber, isString, isUndefined, listenEvent, scoped, tick, waitTimeout } from "./vidstack-CgxsH2Dv.js";
import "fscreen";
//#region src/utils/support.ts
/**
...
//#endregion
//#region src/core/time-ranges.ts
/**
...
//#endregion
//#region src/core/tracks/text/utils.ts
...
//#endregion
//#region src/core/tracks/text/text-track.ts
var TextTrack = class extends EventsTarget {
	...
	*/
	...
	constructor(init) {
		...
		if (!init.src) this[TextTrackSymbol.readyState] = 2;
	}
	addCue(cue, trigger) {
		if (cue.id) {
