import { FileDownloadInfo, LogLevel, MediaCanPlayEvent, MediaControlsChangeEvent, MediaEvents, MediaFullscreenChangeEvent, MediaPlayerProps, MediaPlayerState, MediaRateChangeEvent, MediaTextTrackChangeEvent, MediaTimeUpdateEvent, MediaViewType, MediaVolumeChangeEvent, PlayerSrc, PlyrLayoutProps, PlyrLayoutTranslations, TextTrackInit } from "../types/vidstack-hVlf6lRD.js";
import { MediaPlayerElement, MediaPlyrLayoutElement, MediaProviderElement } from "../types/vidstack-DrJHXsLT.js";

//#region types/global/plyr.d.ts
declare class Plyr implements PlyrProps, PlyrMethods {
  ...
  loop: boolean;
  poster: string;
  get type(): "" | "audio" | "dash" | "google-cast" | "hls" | "video" | "vimeo" | "youtube";
  get isHTML5(): boolean;
  get isEmbed(): boolean;
  get buffered(): number;
  get stopped(): boolean;
...
//#endregion
export { Plyr, PlyrConfig, PlyrEvents, PlyrFullscreenAdapter, PlyrI18nConfig, PlyrKeyboardConfig, PlyrMethods, PlyrProps, PlyrSource, PlyrStorageConfig, PlyrTarget };