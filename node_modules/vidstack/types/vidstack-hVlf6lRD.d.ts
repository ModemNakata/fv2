import { Component, Context, DOMEvent, Dispose, EventsTarget, InferEventDetail, MaverickElementConstructor, MaybeStopEffect, ReadSignal, ReadSignalRecord, Scope, SetRequired, State, Store, ViewController, Writable, WriteSignal } from "./vidstack-DKjAgHWd.js";
import DASH from "dashjs";
import * as HLS from "hls.js";
import { CaptionsFileFormat, CaptionsParserFactory, VTTCue as VTTCue$1, VTTHeaderMetadata, VTTRegion } from "media-captions";

//#region types/foundation/logger/log-level.d.ts
type LogLevel = 'silent' | 'error' | 'warn' | 'info' | 'debug';
//#endregion
//#region types/foundation/logger/grouped-log.d.ts
...
//#endregion
//#region types/foundation/logger/controller.d.ts
...
//#endregion
//#region types/foundation/list/symbols.d.ts
...
//#endregion
//#region types/foundation/list/list.d.ts
interface ListItem {
  id: string;
}
...
//#endregion
//#region types/foundation/fullscreen/events.d.ts
...
//#endregion
//#region types/foundation/fullscreen/controller.d.ts
...
//#endregion
//#region types/foundation/logger/events.d.ts
declare global {
...
//#endregion
//#region types/foundation/orientation/types.d.ts
...
| 'portrait-secondary';
//#endregion
//#region types/foundation/orientation/events.d.ts
...
//#endregion
//#region types/foundation/orientation/controller.d.ts
...
//#endregion
//#region types/core/api/media-request-events.d.ts
...
//#endregion
//#region types/providers/dash/events.d.ts
 ...
 * @detail constructor
 */
interface DASHLibLoadedEvent extends DASHMediaEvent<typeof DASH.MediaPlayer> {}
/**
 ...
 * @detail instance
 */
interface DASHInstanceEvent extends DASHMediaEvent<DASH.MediaPlayerClass> {}
/**
 ...
 * @detail data
 */
interface DASHAstInFutureEvent extends DASHMediaEvent<DASH.AstInFutureEvent> {}
/**
 ...
 * @detail data
 */
interface DASHBufferLoadedEvent extends DASHMediaEvent<DASH.BufferEvent> {}
/**
 ...
 * @detail data
 */
interface DASHBufferStateChangedEvent extends DASHMediaEvent<DASH.BufferStateChangedEvent> {}
/**
 ...
 * @detail data
 */
interface DASHDvbFontDownloadAddedEvent extends DASHMediaEvent<DASH.dvbFontDownloadAdded> {}
/**
 ...
 * @detail data
 */
interface DASHDvbFontDownloadCompleteEvent extends DASHMediaEvent<DASH.dvbFontDownloadComplete> {}
/**
 ...
 * @detail data
 */
interface DASHDvbFontDownloadFailedEvent extends DASHMediaEvent<DASH.dvbFontDownloadFailed> {}
/**
 * Triggered when a dynamic stream changed to static (transition phase between Live and -Demand).
 *
 * @detail data
 */
interface DASHDynamicToStaticEvent extends DASHMediaEvent<DASH.DynamicToStaticEvent> {}
/**
 * Triggered when there is an error from the element or MSE source buffer.
 *
 * @detail error
 */
interface DASHErrorEvent extends DASHMediaEvent<DASH.ErrorEvent> {}
/**
 * Triggered when a fragment download has completed.
 *
 * @detail data
 */
interface DASHFragmentLoadingCompletedEvent extends DASHMediaEvent<DASH.FragmentLoadingCompletedEvent> {}
/**
 ...
 * @detail data
 */
interface DASHFragmentLoadingAbandonedEvent extends DASHMediaEvent<DASH.FragmentLoadingAbandonedEvent> {}
/**
 * Triggered when Debug logger methods are called.
 *
 * @detail data
 */
interface DASHLogEvent extends DASHMediaEvent<DASH.LogEvent> {}
/**
 ...
 * @detail data
 */
interface DASHManifestLoadedEvent extends DASHMediaEvent<DASH.ManifestLoadedEvent> {}
/**
 ...
 * @detail data
 */
interface DASHMetricChangedEvent extends DASHMediaEvent<DASH.MetricChangedEvent> {}
/**
 * Triggered every time a new metric is added.
 *
 * @detail data
 */
interface DASHMetricAddedEvent extends DASHMediaEvent<DASH.MetricEvent> {}
/**
 * Triggered every time a metric is updated.
 *
 * @detail data
 */
interface DASHMetricUpdatedEvent extends DASHMediaEvent<DASH.MetricEvent> {}
/**
 * Triggered when a new stream (period) starts.
 *
 * @detail data
 */
interface DASHPeriodSwitchStartedEvent extends DASHMediaEvent<DASH.PeriodSwitchEvent> {}
/**
 * Triggered at the stream end of a period.
 *
 * @detail data
 */
interface DASHPeriodSwitchCompletedEvent extends DASHMediaEvent<DASH.PeriodSwitchEvent> {}
/**
 ...
 * @detail data
 */
interface DASHQualityChangeRequestedEvent extends DASHMediaEvent<DASH.QualityChangeRequestedEvent> {}
/**
 * Triggered when the new ABR quality is being rendered on-screen.
 *
 * @detail data
 */
interface DASHQualityChangeRenderedEvent extends DASHMediaEvent<DASH.QualityChangeRenderedEvent> {}
/**
 * Triggered when the new track is being rendered.
 *
 * @detail data
 */
interface DASHTrackChangeRenderedEvent extends DASHMediaEvent<DASH.TrackChangeRenderedEvent> {}
/**
 ...
 * @detail data
 */
interface DASHStreamInitializedEvent extends DASHMediaEvent<DASH.StreamInitializedEvent> {}
/**
 ...
 * @detail data
 */
interface DASHAllTextTracksAddedEvent extends DASHMediaEvent<DASH.TextTracksAddedEvent> {}
/**
 * Triggered when a text track is added to the video element's `TextTrackList`.
 *
 * @detail data
 */
interface DASHTextTrackAddedEvent extends DASHMediaEvent<DASH.TextTracksAddedEvent> {}
/**
 * Triggered when a text track should be shown.
 *
 * @detail data
 */
interface DASHCueEnterEvent extends DASHMediaEvent<DASH.CueEnterEvent> {}
/**
 * Triggered when a text track should be hidden.
 *
 * @detail data
 */
interface DASHCueExitEvent extends DASHMediaEvent<DASH.CueExitEvent> {}
/**
 ...
 * @detail data
 */
interface DASHTtmlParsedEvent extends DASHMediaEvent<DASH.TtmlParsedEvent> {}
/**
 * Triggered when a `ttml` chunk has to be parsed.
 *
 * @detail data
 */
interface DASHTtmlToParseEvent extends DASHMediaEvent<DASH.TtmlToParseEvent> {}
/**
 * Triggered when a caption is rendered.
 *
 * @detail data
 */
interface DASHCaptionRenderedEvent extends DASHMediaEvent<DASH.CaptionRenderedEvent> {}
/**
 * Triggered when the caption container is resized.
 *
 * @detail data
 */
interface DASHCaptionContainerResizeEvent extends DASHMediaEvent<DASH.CaptionContainerResizeEvent> {}
/**
 ...
 * @detail data
 */
interface DASHPlaybackErrorEvent extends DASHMediaEvent<DASH.PlaybackErrorEvent> {}
/**
 ...
 * @detail data
 */
interface DASHPlaybackPausedEvent extends DASHMediaEvent<DASH.PlaybackPausedEvent> {}
/**
 ...
 * @detail data
 */
interface DASHPlaybackPlayingEvent extends DASHMediaEvent<DASH.PlaybackPlayingEvent> {}
/**
 ...
 * @detail data
 */
interface DASHPlaybackRateChangedEvent extends DASHMediaEvent<DASH.PlaybackRateChangedEvent> {}
/**
 ...
 * @detail data
 */
interface DASHPlaybackSeekingEvent extends DASHMediaEvent<DASH.PlaybackSeekingEvent> {}
/**
 ...
 * @detail data
 */
interface DASHPlaybackStartedEvent extends DASHMediaEvent<DASH.PlaybackStartedEvent> {}
/**
 * The time indicated by the element's currentTime attribute has changed.
 *
 * @detail data
 */
interface DASHPlaybackTimeUpdatedEvent extends DASHMediaEvent<DASH.PlaybackTimeUpdatedEvent> {}
/**
 ...
 * @detail data
 */
interface DASHPlaybackWaitingEvent extends DASHMediaEvent<DASH.PlaybackWaitingEvent> {}
/**
 ...
 * @detail data
 */
interface DASHAdaptationSetRemovedNoCapabilitiesEvent extends DASHMediaEvent<DASH.AdaptationSetRemovedNoCapabilitiesEvent> {}
/**
 ...
 * @detail data
 */
interface DASHInbandPrftEvent extends DASHMediaEvent<DASH.InbandPrftReceivedEvent> {}
/**
...
//#endregion
//#region types/providers/google-cast/events.d.ts
...
//#endregion
//#region types/providers/hls/events.d.ts
...
//#endregion
//#region types/providers/video/presentation/events.d.ts
...
//#endregion
//#region types/core/api/player-events.d.ts
...
//#endregion
//#region types/providers/google-cast/types.d.ts
interface GoogleCastOptions extends Partial<cast.framework.CastOptions> {}
//#endregion
//#region types/core/state/remote-control.d.ts
/**
...
//#endregion
//#region types/core/keyboard/types.d.ts
...
//#endregion
//#region types/core/api/src-types.d.ts
...
//#endregion
//#region types/core/state/media-storage.d.ts
...
//#endregion
//#region types/foundation/list/select-list.d.ts
...
//#endregion
//#region types/core/quality/events.d.ts
...
//#endregion
//#region types/core/quality/symbols.d.ts
declare const SET_AUTO: unique symbol, ENABLE_AUTO: unique symbol;
/** @internal */
...
//#endregion
//#region types/core/quality/video-quality.d.ts
/**
...
//#endregion
//#region types/core/state/media-player-delegate.d.ts
...
//#endregion
//#region types/core/tracks/audio/events.d.ts
...
//#endregion
//#region types/core/tracks/audio/audio-tracks.d.ts
/**
...
//#endregion
//#region types/core/tracks/text/events.d.ts
...
//#endregion
//#region types/core/tracks/text/symbols.d.ts
declare const CROSS_ORIGIN: unique symbol, READY_STATE: unique symbol, UPDATE_ACTIVE_CUES: unique symbol, CAN_LOAD: unique symbol, ON_MODE_CHANGE: unique symbol, NATIVE: unique symbol, NATIVE_HLS: unique symbol;
...
//#endregion
//#region types/core/tracks/text/text-track.d.ts
/**
 * - 0: Not Loading
 * - 1: Loading
 * - 2: Ready
...
//#endregion
//#region types/core/tracks/text/render/text-renderer.d.ts
...
//#endregion
//#region types/core/tracks/text/text-tracks.d.ts
/**
...
//#endregion
//#region types/core/api/media-context.d.ts
...
//#endregion
//#region types/core/api/types.d.ts
/**
...
//#endregion
//#region types/providers/html/audio/audio-gain.d.ts
...
//#endregion
//#region types/providers/html/provider.d.ts
/**
...
declare class HTMLMediaProvider implements MediaProviderAdapter {
  ...
  loadSource({
    src,
    type
  }: Src, preload?: HTMLMediaElement['preload']): Promise<void>;
  /**
...
//#endregion
//#region types/providers/audio/provider.d.ts
/**
...
//#endregion
//#region types/providers/video/provider.d.ts
/**
...
//#endregion
//#region types/providers/dash/types.d.ts
type DASHConstructor = typeof DASH.MediaPlayer;
type DASHConstructorLoader = () => Promise<{
  default: DASHConstructor;
} | undefined>;
type DASHNamespace = typeof DASH;
...
type DASHInstanceCallback = (player: DASH.MediaPlayerClass) => void;
//#endregion
//#region types/providers/dash/provider.d.ts
/**
...
//#endregion
//#region types/providers/google-cast/provider.d.ts
/**
...
//#endregion
//#region types/providers/hls/types.d.ts
...
//#endregion
//#region types/providers/hls/provider.d.ts
/**
...
//#endregion
//#region types/providers/embed/EmbedProvider.d.ts
...
//#endregion
//#region types/providers/vimeo/embed/event.d.ts
...
//#endregion
//#region types/providers/vimeo/embed/command.d.ts
/**
 * @see https://github.com/vimeo/player.js#methods
 */
type VimeoCommand = 'addEventListener' | 'disableTextTrack' | 'enableTextTrack' | 'exitFullscreen' | 'exitPictureInPicture' | 'getBuffered' | 'getCuePoints' | 'getChapters' | 'getCurrentTime' | 'getDuration' | 'getFullscreen' | 'getMuted' | 'getPictureInPicture' | 'getPlayed' | 'getQualities' | 'getQuality' | 'getSeekable' | 'getSeeking' | 'getTextTracks' | 'getVideoTitle' | '_hideOverlay' | 'pause' | 'play' | 'requestFullscreen' | 'requestPictureInPicture' | 'seekTo' | 'setMuted' | 'setPlaybackRate' | 'setQuality' | 'setVolume' | '_showOverlay' | 'destroy' | 'loadVideo' | 'unload';
//#endregion
//#region types/providers/vimeo/embed/message.d.ts
...
//#endregion
//#region types/providers/vimeo/embed/params.d.ts
/**
...
//#endregion
//#region types/providers/vimeo/provider.d.ts
/**
...
//#endregion
//#region types/providers/youtube/embed/message.d.ts
...
//#endregion
//#region types/providers/youtube/embed/params.d.ts
/**
...
//#endregion
//#region types/providers/youtube/provider.d.ts
/**
...
declare class YouTubeProvider extends EmbedProvider<YouTubeMessage> implements MediaProviderAdapter, Pick<YouTubeParams, 'color' | 'start' | 'end'> {
  ...
  protected onMessage({
    info
  }: YouTubeMessage, event: MessageEvent): void;
}
//#endregion
//#region types/providers/types.d.ts
...
//#endregion
//#region types/core/api/player-state.d.ts
...
//#endregion
//#region types/core/api/player-props.d.ts
...
type MediaPlayerAriaLabel = string;
...
//#endregion
//#region types/foundation/queue/request-queue.d.ts
...
//#endregion
//#region types/components/player.d.ts
declare global {
...
//#endregion
//#region types/core/api/media-events.d.ts
...
//#endregion
//#region types/core/tracks/text/render/libass-text-renderer.d.ts
...
//#endregion
//#region types/core/tracks/text/utils.d.ts
...
//#endregion
//#region types/core/time-ranges.d.ts
...
//#endregion
//#region types/providers/type-check.d.ts
...
//#endregion
//#region types/providers/audio/loader.d.ts
...
//#endregion
//#region types/providers/video/loader.d.ts
...
//#endregion
//#region types/providers/hls/loader.d.ts
...
//#endregion
//#region types/providers/dash/loader.d.ts
...
//#endregion
//#region types/providers/google-cast/loader.d.ts
...
//#endregion
//#region types/providers/vimeo/loader.d.ts
...
//#endregion
//#region types/providers/youtube/loader.d.ts
...
//#endregion
//#region types/components/provider/provider.d.ts
...
//#endregion
//#region types/components/aria/announcer.d.ts
/**
...
type MediaAnnouncerTranslations = { [word in MediaAnnouncerWord]: string };
//#endregion
//#region types/components/ui/controls.d.ts
/**
...
//#endregion
//#region types/components/ui/controls-group.d.ts
/**
...
//#endregion
//#region types/components/ui/tooltip/tooltip.d.ts
/**
...
//#endregion
//#region types/components/ui/tooltip/tooltip-trigger.d.ts
/**
...
//#endregion
//#region types/components/ui/tooltip/tooltip-content.d.ts
/**
...
//#endregion
//#region types/components/ui/buttons/toggle-button.d.ts
...
//#endregion
//#region types/components/ui/buttons/toggle-button-controller.d.ts
...
//#endregion
//#region types/components/ui/buttons/airplay-button.d.ts
...
//#endregion
//#region types/components/ui/buttons/google-cast-button.d.ts
...
//#endregion
//#region types/components/ui/buttons/play-button.d.ts
...
//#endregion
//#region types/components/ui/buttons/caption-button.d.ts
...
//#endregion
//#region types/components/ui/buttons/fullscreen-button.d.ts
...
//#endregion
//#region types/components/ui/buttons/mute-button.d.ts
...
//#endregion
//#region types/components/ui/buttons/pip-button.d.ts
...
//#endregion
//#region types/components/ui/buttons/seek-button.d.ts
...
//#endregion
//#region types/components/ui/buttons/live-button.d.ts
...
//#endregion
//#region types/components/ui/sliders/slider/api/cssvars.d.ts
...
//#endregion
//#region types/components/ui/sliders/slider/api/state.d.ts
...
//#endregion
//#region types/components/ui/sliders/slider/events-controller.d.ts
...
//#endregion
//#region types/components/ui/sliders/slider/types.d.ts
type SliderOrientation = 'horizontal' | 'vertical';
//#endregion
//#region types/components/ui/sliders/slider/slider-controller.d.ts
...
//#endregion
//#region types/components/ui/sliders/slider/slider.d.ts
/**
...
//#endregion
//#region types/components/ui/sliders/slider/api/events.d.ts
...
//#endregion
//#region types/components/ui/thumbnails/thumbnail-loader.d.ts
...
//#endregion
//#region types/components/ui/thumbnails/thumbnail.d.ts
/**
...
//#endregion
//#region types/components/ui/sliders/slider-thumbnail.d.ts
/**
...
//#endregion
//#region types/components/ui/sliders/slider-video.d.ts
/**
...
//#endregion
//#region types/components/ui/sliders/slider-value.d.ts
/**
...
//#endregion
//#region types/components/ui/sliders/slider-preview.d.ts
/**
...
declare function updateSliderPreviewPlacement(el: HTMLElement, {
  clamp,
  offset,
  orientation
}: {
...
//#endregion
//#region types/components/ui/sliders/volume-slider.d.ts
/**
...
//#endregion
//#region types/components/ui/sliders/audio-gain-slider.d.ts
/**
...
//#endregion
//#region types/components/ui/sliders/speed-slider.d.ts
/**
...
//#endregion
//#region types/components/ui/sliders/quality-slider.d.ts
/**
...
//#endregion
//#region types/components/ui/sliders/time-slider/time-slider.d.ts
/**
...
//#endregion
//#region types/components/ui/sliders/time-slider/slider-chapters.d.ts
/**
...
//#endregion
//#region types/components/ui/sliders/slider/slider-context.d.ts
...
//#endregion
//#region types/components/ui/menu/menu.d.ts
/**
...
//#endregion
//#region types/components/ui/menu/menu-button.d.ts
/**
...
//#endregion
//#region types/components/ui/menu/menu-item.d.ts
/**
...
//#endregion
//#region types/components/ui/menu/menu-portal.d.ts
/**
...
//#endregion
//#region types/components/ui/menu/menu-items.d.ts
/**
...
//#endregion
//#region types/components/ui/menu/radio/radio-group.d.ts
/**
...
//#endregion
//#region types/components/ui/menu/radio/radio.d.ts
/**
...
//#endregion
//#region types/components/ui/menu/radio-groups/chapters-radio-group.d.ts
/**
...
//#endregion
//#region types/components/ui/menu/radio-groups/audio-radio-group.d.ts
/**
...
//#endregion
//#region types/components/ui/menu/radio-groups/audio-gain-radio-group.d.ts
...
//#endregion
//#region types/components/ui/menu/radio-groups/captions-radio-group.d.ts
/**
...
//#endregion
//#region types/components/ui/menu/radio-groups/speed-radio-group.d.ts
...
//#endregion
//#region types/components/ui/menu/radio-groups/quality-radio-group.d.ts
/**
...
//#endregion
//#region types/components/ui/gesture.d.ts
/**
...
//#endregion
//#region types/components/ui/captions/captions.d.ts
...
declare class Captions extends Component<CaptionsProps> {
  ...
  static lib: WriteSignal<typeof import("media-captions") | null>;
  protected onSetup(): void;
  protected onAttach(el: HTMLElement): void;
  protected onConnect(el: HTMLElement): void;
}
//#endregion
//#region types/components/ui/poster.d.ts
...
//#endregion
//#region types/components/ui/time.d.ts
/**
...
//#endregion
//#region types/utils/network.d.ts
type FileDownloadInfo = boolean | string | {
  url: string;
  filename: string;
} | null;
declare function getDownloadFile({
  title,
  src,
  download
}: {
...
//#endregion
//#region types/components/layouts/default/translations.d.ts
...
type DefaultLayoutTranslations = { [word in DefaultLayoutWord]: string };
//#endregion
//#region types/components/layouts/default/props.d.ts
...
//#endregion
//#region types/components/layouts/plyr/translations.d.ts
...
type PlyrLayoutTranslations = { [word in PlyrLayoutWord]: string };
//#endregion
//#region types/components/layouts/plyr/props.d.ts
...
//#endregion
//#region types/components/layouts/plyr/plyr-layout.d.ts
...
//#endregion
//#region types/elements/define/chapter-title-element.d.ts
...
//#endregion
//#region types/elements/define/layouts/layout-element.d.ts
...
//#endregion
//#region types/elements/lit/lit-element.d.ts
...
//#endregion
//#region types/elements/define/spinner-element.d.ts
...
//#endregion
//#region types/utils/support.d.ts
/**
