import { DOMEvent, createDisposalBin, isBoolean, isString, kebabToCamelCase, listenEvent, setAttribute, setStyle } from "../chunks/vidstack-BwClSYSC.js";
import { isHTMLAudioElement, isHTMLIFrameElement, isHTMLVideoElement, mediaState } from "../chunks/vidstack-BWkbKDUg.js";
import { canPlayVideoType } from "../chunks/vidstack-gDipnrck.js";
import { isHTMLElement } from "../chunks/vidstack-CToJFZVs.js";
...
var Plyr = class Plyr {
	...
	constructor(target, config = {}) {
		...
		const { enabled = true, debug = "warn", autoPause = true, ratio = null, hideControls = true, resetOnEnd = false, disableContextMenu = true, iconUrl = null, iconPrefix = "plyr", keyboard = {
			focused: true,
			global: false
