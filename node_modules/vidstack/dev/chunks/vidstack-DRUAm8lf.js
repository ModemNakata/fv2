import { DOMEvent, EventsController, createScope, effect, isNil, isString, listenEvent, onDispose, peek, setAttribute, signal } from "./vidstack-BwClSYSC.js";
import { ListSymbol, RAFLoop } from "./vidstack-BzoKHzuo.js";
import { IS_IOS, IS_SAFARI, isHLSSrc, isMediaStream } from "./vidstack-gDipnrck.js";
import { getNumberOfDecimalPlaces } from "./vidstack-CZQo98ic.js";
//#region src/providers/html/audio/audio-context.ts
...
//#endregion
//#region src/providers/html/audio/audio-gain.ts
var AudioGain = class {
	#media;
	#onChange;
	#gainNode = null;
...
//#endregion
//#region src/foundation/observers/page-visibility.ts
const PAGE_EVENTS = [
	"focus",
	"blur",
	"visibilitychange",
...
//#endregion
//#region src/providers/html/html–media-events.ts
var HTMLMediaEvents = class {
	...
	*/
	...
	#onDevEvent(event) {
		this.#ctx.logger?.debugGroup(`📺 provider fired \`${event.type}\``).labelledLog("Provider", this.#provider).labelledLog("Event", event).labelledLog("Media Store", { ...this.#ctx.$state }).dispatch();
...
//#endregion
//#region src/providers/html/native-audio-tracks.ts
...
//#endregion
//#region src/providers/html/provider.ts
/**
