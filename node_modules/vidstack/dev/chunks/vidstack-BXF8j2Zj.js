import { DOMEvent, camelToKebabCase, effect, isFunction, isNumber, isString, isUndefined, listenEvent, peek } from "./vidstack-BwClSYSC.js";
import { ListSymbol, RAFLoop } from "./vidstack-BzoKHzuo.js";
import { IS_CHROME, canPlayAudioType, canPlayVideoType, isDASHSupported } from "./vidstack-gDipnrck.js";
import { loadScript, preconnect } from "./vidstack-CgNu5UhN.js";
import { TextTrack, TextTrackSymbol } from "./vidstack-BpQc-xfw.js";
import { QualitySymbol } from "./vidstack-BkDwYdN3.js";
import { VideoProvider } from "./vidstack-D7y3EttX.js";
...
async function loadDASHScript(src, callbacks = {}) {
	...
	try {
		...
		if (!isFunction(window.dashjs.MediaPlayer)) throw Error("[vidstack] failed loading `dash.js`. Could not find a valid `Dash` constructor on window");
