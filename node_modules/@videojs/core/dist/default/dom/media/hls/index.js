...
import { bridgeEvents } from "../../../core/utils/bridge-events.js";
import { NativeHlsMedia } from "../native-hls/index.js";
import { HlsJsMedia } from "./hlsjs.js";
...
var HlsMedia = class extends HTMLVideoElementHost {
	#delegate = null;
	...
	*/
	...
	load() {
		...
		if (this.#shouldEngineUpdate(this.#engineProps())) {
			...
			this.#delegate = useMse ? new HlsJsMedia({ config: {
				...this.config,
				debug: this.debug
			} }) : new NativeHlsMedia();
	...
	#shouldEngineUpdate(nextEngineProps) {
...
function inferSourceType(src) {
	if ((src.split(/[?#]/)[0] ?? "").endsWith(".mp4")) return SourceTypes.MP4;
	return SourceTypes.M3U8;
}
//#endregion
export { Hls, HlsMedia, PlaybackTypes, SourceTypes, StreamTypes, hlsMediaDefaultProps };
