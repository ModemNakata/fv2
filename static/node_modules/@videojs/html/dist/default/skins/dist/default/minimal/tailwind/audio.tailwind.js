...
const controls = cn(controls$1, "p-1.5 gap-2", "rounded-(--media-border-radius,1rem)", "peer-data-open/error:**:invisible", "text-(--media-controls-text-color)", "ring-1 ring-(color:--media-controls-border-color)");
const popup = {
	...popup$1,
...
//#endregion
export { controls, error, popup, root };
