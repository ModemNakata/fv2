...
*/
const inputFeedback = {
	root: cn("absolute inset-x-0 top-0 bottom-14 pointer-events-none", "grid grid-cols-3 items-center justify-items-center overflow-hidden", "rounded-[inherit]", "@2xl/media-root:bottom-0", "[color:var(--media-color-primary,oklch(1_0_0))]"),
	island: {
		...
		content: cn("flex justify-between items-center gap-2 px-2.5 py-1", "*:last:ml-auto", "[@media(prefers-reduced-transparency:reduce)]:bg-(--media-controls-background-color)", "[@media(prefers-reduced-transparency:reduce)]:rounded-lg", "contrast-more:bg-(--media-controls-background-color) contrast-more:rounded-lg"),
		...
		shownFullscreenEnter: cn("group-data-[status=fullscreen]/input-indicator:block", "motion-safe:group-not-data-starting-style/input-indicator:group-data-[status=fullscreen]/input-indicator:animate-media-pop-in"),
		shownFullscreenExit: cn("group-data-[status=exit-fullscreen]/input-indicator:block", "motion-safe:group-not-data-starting-style/input-indicator:group-data-[status=exit-fullscreen]/input-indicator:animate-media-pop-in"),
		shownPipEnter: cn("group-data-[status=pip]/input-indicator:block", "motion-safe:group-not-data-starting-style/input-indicator:group-data-[status=pip]/input-indicator:animate-media-pop-in"),
		shownPipExit: cn("group-data-[status=exit-pip]/input-indicator:block", "motion-safe:group-not-data-starting-style/input-indicator:group-data-[status=exit-pip]/input-indicator:animate-media-pop-in"),
		value: "ml-auto"
	},
	bubble: {
		base: cn("group/input-indicator", "col-start-2 row-start-1", "flex flex-col items-center justify-center p-4", "transition-opacity duration-250 ease-out", "data-starting-style:opacity-0", "data-ending-style:opacity-0", "data-starting-style:duration-200", "data-starting-style:ease-in", "data-ending-style:duration-200", "data-ending-style:ease-in", "@2xl/media-root:p-8", "not-data-direction:[transition-property:opacity,scale]", "not-data-direction:duration-600", "not-data-direction:[transition-timing-function:ease-out,linear(0,0.12_1.5%,1.35_9.7%,2.2_13.9%,3_19.9%,2.7_21.8%,0.62_37.5%,0.96_50.9%,1)]", "motion-reduce:not-data-direction:transition-opacity", "motion-reduce:not-data-direction:duration-100", "motion-reduce:not-data-direction:ease-out", "not-data-direction:data-starting-style:scale-80", "not-data-direction:data-ending-style:scale-80", "not-data-direction:data-starting-style:duration-200", "not-data-direction:data-starting-style:ease-in", "not-data-direction:data-ending-style:duration-200", "not-data-direction:data-ending-style:ease-in", "data-[direction=backward]:col-start-1 data-[direction=backward]:justify-self-start", "data-[direction=forward]:col-start-3 data-[direction=forward]:justify-self-end"),
		icon: "hidden w-9 h-9",
		shownSeek: cn("group-data-direction/input-indicator:block", "group-data-[direction=backward]/input-indicator:-scale-x-100", "group-not-data-starting-style/input-indicator:group-data-[direction=forward]/input-indicator:animate-media-slide-in-forward", "group-not-data-starting-style/input-indicator:group-data-[direction=backward]/input-indicator:animate-media-slide-in-backward", "motion-reduce:group-data-direction/input-indicator:animate-none"),
		shownPause: cn("group-data-[status=pause]/input-indicator:block", "motion-safe:group-not-data-starting-style/input-indicator:group-data-[status=pause]/input-indicator:animate-media-pop-in"),
		shownPlay: cn("group-data-[status=play]/input-indicator:block", "motion-safe:group-not-data-starting-style/input-indicator:group-data-[status=play]/input-indicator:animate-media-pop-in"),
		time: "tabular-nums"
	}
};
//#endregion
