...
const controls = cn(controls$1, surface, "text-(--media-text-color)", "peer-data-open/error:**:invisible");
const slider = {
	...slider$1,
...
({ ...bufferingIndicator$1 }), cn(bufferingIndicator$1.container, surface);
const error = {
	...error$1,
...
//#endregion
export { controls, error, popup, root, slider };
