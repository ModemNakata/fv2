...
3.  **Add `.md` to any URL** : append `.md` to any doc URL to get its markdown directly. For example, the PlayButton reference is available at [`videojs.org/docs/framework/html/reference/play-button.md`](../reference/play-button.md).
    

### llms.txt

[`videojs.org/docs/framework/html/llms.txt`](../llms.txt) is an index of the full documentation: every page with a title and description. Add it to your project’s context so your AI knows what’s available.
