...
type HandlerContext<UserState extends string, Context extends object, RunnerFactory extends (() => RunnerLike) | undefined> = {
  transition: (to: UserState) => void; /** Context snapshot captured at dispatch time. Stale after any `setContext` call. */
  context: Context;
  /**
...
type ActorStateDefinition<UserState extends string, Context extends object, Message extends {
   ...
   */
  onSettled?: UserState; /** Message handlers active in this state. Messages with no handler are silently dropped. */
...
type ActorDefinition<UserState extends string, Context extends object, Message extends {
   ...
   */
  runner?: RunnerFactory; /** Initial state. */
  initial: UserState; /** Initial context. */
  context: Context;
  /**
