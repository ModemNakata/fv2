...
declare const TransitionDataAttrs: {
  /** Present during the open transition. */readonly transitionStarting: 'data-starting-style'; /** Present during the close transition. */
  readonly transitionEnding: 'data-ending-style';
};
declare function getTransitionFlags(status: TransitionStatus): TransitionFlags;
declare function getTransitionStyleAttrs({
  transitionStarting,
  transitionEnding
